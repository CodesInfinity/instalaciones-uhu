<%-- 
    Document   : pagoReserva.jsp
    Created on : 13 nov 2025
    Author     : agustinrodriguez
    Description: PASARELA DE PAGO (STRIPE)
                 Vista final del proceso de reserva. Muestra el resumen y el formulario de tarjeta.
--%>
...
<script src="${pageContext.request.contextPath}/scripts/pago.js"></script>