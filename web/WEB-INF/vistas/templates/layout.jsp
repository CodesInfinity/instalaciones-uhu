<%-- 
    ...
    Description: PLANTILLA MAESTRA (LAYOUT)
                 Este archivo define la estructura común de todas las páginas del sitio.
                 Contiene:
                 1. Cabecera (<head>) con estilos y metaetiquetas.
                 2. Barra de navegación (Navbar) responsiva y sensible al rol del usuario.
                 3. Área de contenido dinámico donde se inyectan las vistas específicas.
                 4. Pie de página (Footer) y Modals globales.
--%>
...
<html lang="es">
    <head>
        ...
        <%-- Font-awesome para hacer uso de iconos dentro de la app --%>
    ...
    <body class="panel-body">
                                ...
                                <c:when test="${not empty sessionScope.usuario}">
                                    <div class="user-profile">
                                        ...
                                        <div class="user-dropdown">
                                            ...
                                            <%-- OPCIONES SOLO PARA ADMINISTRADORES (Rol 0) --%>
                                            ...
                                            <%-- OPCIONES PARA NO ADMINS (Editar Perfil) --%>
                                            <c:if test="${sessionScope.usuario.rol != 0}">
                                                <a href="${pageContext.request.contextPath}/usuario/editar" class="dropdown-item">
                                                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                                                              d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
                                                    </svg>
                                            ...
                                            <a href="javascript:void(0)" onclick="confirmarLogout()" class="dropdown-item logout-item">
                                                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
                            ...
                            <div class="mobile-user-section">
                                ...
                                <div class="mobile-nav-actions">
                                    <c:if test="${sessionScope.usuario.rol == 0}">
                                        ...
                                        <a href="${pageContext.request.contextPath}/reservas/panel" class="btn-nav btn-nav-primary mobile">
                                            Gestión de Reservas
                                        </a>
                                    </c:if>
                                    <a href="javascript:void(0)" onclick="confirmarLogout()" class="btn-nav btn-nav-secondary mobile">
                                        Cerrar Sesión
                                    </a>
                                </div>
                            </div>
        ...
        <div id="logoutModal" class="modal-overlay" style="display: none;">
            <div class="modal-content">
                ...
                <div class="modal-actions">
                    <button onclick="cerrarModalLogout()" class="modal-btn modal-btn-cancel">
                        Cancelar
                    </button>
                    <a href="${pageContext.request.contextPath}/usuario/logout" class="modal-btn modal-btn-confirm">
                        Sí, cerrar sesión
                    </a>
                </div>
            </div>
        ...
        <script src="${pageContext.request.contextPath}/scripts/validacion-formularios.js"></script>        
        <script src="${pageContext.request.contextPath}/scripts/logout.js"></script>
    </body>
</html>