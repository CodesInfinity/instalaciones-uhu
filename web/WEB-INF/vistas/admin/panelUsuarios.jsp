<%-- 
    Document   : panelUsuarios.jsp
    Created on : 26 oct 2025, 0:30:04
    Author     : agustinrodriguez
    Description: PANEL DE ADMINISTRACIÓN DE USUARIOS
                 Tabla principal para listar, editar y eliminar usuarios registrados.
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="table-actions">
                                    <%-- Protección: No permitir editar/borrar a otros administradores desde aquí (opcional) o a sí mismo --%>
                                    <c:if test="${usuario.rol != 0}">
                                        ...
                                        <a href="${pageContext.request.contextPath}/usuario/borrar?id=${usuario.id}" 
